...
public final class Messages {
    ...
    public static final String HI_I_AM = "HI, I'M ";
    ...
    public static final String BYE_MATE = "BYE MATE!";
    public static final String SORRY_DID_NOT_UNDERSTAND_THAT = "SORRY, I DIDN’T UNDERSTAND THAT";
